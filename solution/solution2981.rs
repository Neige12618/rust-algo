...
/// </ul>
/// <a href="https://leetcode.cn/problems/find-longest-special-substring-that-occurs-thrice-i/">找出出现至少三次的最长特殊子字符串 I</a>
pub struct Solution;
...
impl Solution {
    pub fn maximum_length(s: String) -> i32 {
        ...
        for c in char_map.values_mut() {
            c.sort_unstable();
            c.extend((0..2).map(|_| Reverse(0)));
            result = result
                .max(c[0].0 - 2) // 最长的 - 2

...
/// </ul>
/// <a href="https://leetcode.cn/problems/find-kth-largest-xor-coordinate-value/">找出第 K 大的异或坐标值</a>
pub struct Solution;
...
impl Solution {
    pub fn kth_largest_value(matrix: Vec<Vec<i32>>, k: i32) -> i32 {
        ...
        *queue.select_nth_unstable(m * n - k as usize).1
    }
}

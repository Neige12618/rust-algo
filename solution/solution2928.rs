...
/// </ul>
/// <a href="https://leetcode.cn/problems/distribute-candies-among-children-i/">给小朋友们分糖果 I</a>
pub struct Solution;
...
impl Solution {
    pub fn distribute_candies(n: i32, limit: i32) -> i32 {
        ...
        for i in (0..=n.min(limit)).rev() {
            ...
            ans += limit.min(remain) - 0.max(remain - limit) + 1;
        }
        return ans;
    }

    pub fn distribute_candies_math(n: i32, limit: i32) -> i32 {
        let c_2 = |n| if n <= 0 { 0 } else { n * (n - 1) / 2 };

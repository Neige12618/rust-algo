...
/// </ul>
/// <a href="https://leetcode.cn/problems/account-balance-after-rounded-purchase/">取整购买后的账户余额</a>
pub struct Solution;
...
impl Solution {
    pub fn account_balance_after_purchase(purchase_amount: i32) -> i32 {
        ...
        if m < 5 {
            100 - (purchase_amount - m)
        } else {
            100 - (purchase_amount + 10 - m)
        }
    }
}
...
mod test {
    ...
    #[test]
    fn test_1() {
        assert_eq!(Solution::account_balance_after_purchase(39), 60);
        assert_eq!(Solution::account_balance_after_purchase(35), 60)
    }
}
